...
public class TasksTest {
    ...
    public void newTasksTest() {
        try {
            ...
            // deadline
            Deadline deadline = new Deadline("deadline", DateTimeTool.parseDateTime("30/1/2026 1800"));
            assertEquals("[D][ ] deadline (by: Jan 30 2026 6PM)", deadline.toString());
            deadline = new Deadline("deadline", DateTimeTool.parseDateTime("30/1/2026 1801"));
            assertEquals("[D][ ] deadline (by: Jan 30 2026 6.01PM)", deadline.toString());

            // event
            Event event = new Event("event", DateTimeTool.parseDateTime("30/1/2026 1800"),
                    DateTimeTool.parseDateTime("30/1/2026 1801"));
